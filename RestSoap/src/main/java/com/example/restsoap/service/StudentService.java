package com.example.restsoap.service;

import com.example.restsoap.model.Course;
import com.example.restsoap.model.Student;
...
public class StudentService {
  ...
  public Student retrieveStudent(String studentId){
    return students.stream().filter(s -> s.id().equalsIgnoreCase(studentId)).findAny().orElse(null);
  }
...
//    }
  ...
  public Course retrieveCourse(String studentId, String courseId){
    ...
    if(student == null)
      return null;
    return student.courses().stream().filter(c -> c.id().equalsIgnoreCase(courseId)).findAny().orElse(null);
  }
  ...
  public Course addCourse(String studentId, Course course){
    ...
    if(course == null){
      course = new Course(randomId, "Course" + randomId, "Description" + randomId, Collections.singletonList(""));
    }
